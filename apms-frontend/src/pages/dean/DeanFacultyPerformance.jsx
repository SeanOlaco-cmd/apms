...
export default function DeanFacultyPerformance() {
  ...
  const handleSubmit = async () => {
    ...
    setSuccess("");
    try {
      await api.post("/faculty-performance", form);
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-[#7b1113] rounded-2xl p-6 text-white">
        ...
        <p className="text-red-200 text-sm mt-1">Submit faculty performance data for your school. VPAA reviews and approves.</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="text-sm font-medium text-gray-700">Average Evaluation Score</label>
            <input type="number" step="0.01" name="average_evaluation_score" value={form.average_evaluation_score} onChange={handleChange}
          ...
          <div>
            <label className="text-sm font-medium text-gray-700">With Master's Degree</label>
