...
export default function DeanFacultyPerformance() {
  ...
  const handleApprove = async (id) => {
    await api.put(`/faculty-performance/${id}`, { status: "approved", approved_by: user.id, approved_at: new Date().toISOString() });
    loadData();
  };
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-[#7b1113] rounded-2xl p-6 text-white">
        ...
        <p className="text-red-200 text-sm mt-1">Review and approve faculty performance data.</p>
      </div>
