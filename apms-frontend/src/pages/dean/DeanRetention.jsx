  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-[#7b1113] rounded-2xl p-6 text-white">
        <h1 className="text-2xl font-bold">Retention Data 📈</h1>
        <p className="text-red-200 text-sm mt-1">
          Retention data submitted by the Registrar for your school. Read-only.
        </p>
      </div>
            ...
            <tbody>
              {submissions.map((row) => (
                <tr key={row.id} className="border-b border-gray-50 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">{row.graduated_students}</td>
                </tr>
              ))}
            </tbody>
          </table>
