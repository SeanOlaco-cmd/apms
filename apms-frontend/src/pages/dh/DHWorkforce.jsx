...
export default function DHWorkforce() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccess("Workforce data submitted! Waiting for Dean approval.");
      setForm({
        academic_period_id: "",
        faculty_needed: "",
        vacant_positions: "",
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-[#7b1113] rounded-2xl p-6 text-white">
        ...
        <p className="text-red-200 text-sm mt-1">Submit workforce requirements for your school.</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="text-sm font-medium text-gray-700">Faculty Needed</label>
            <input type="number" name="faculty_needed" value={form.faculty_needed} onChange={handleChange}
              className="mt-1 w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#7b1113]"
              placeholder="0" />
          </div>
          <div>
            <label className="text-sm font-medium text-gray-700">Vacant Positions</label>
            <input type="number" name="vacant_positions" value={form.vacant_positions} onChange={handleChange}
              className="mt-1 w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#7b1113]"
              placeholder="0" />
          </div>
          <div>
            <label className="text-sm font-medium text-gray-700">Positions Filled</label>
            <input type="number" name="positions_filled" value={form.positions_filled} onChange={handleChange}
              className="mt-1 w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#7b1113]"
              placeholder="0" />
          </div>
          <div>
          ...
          <div className="col-span-2">
            <label className="text-sm font-medium text-gray-700">Specialization Needed</label>
            <input type="text" name="specialization_needed" value={form.specialization_needed} onChange={handleChange}
              className="mt-1 w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#7b1113]"
              placeholder="e.g. Network Engineering, Data Science..." />
          </div>
          <div className="col-span-2">
