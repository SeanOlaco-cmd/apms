...
export default function DHBoardExam() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setForm({ academic_period_id: activePeriodId, exam_name: "", exam_date: "", total_examinees: "", total_passers: "", passing_rate: "", first_timers: "", first_timer_passers: "", first_timer_passing_rate: "", notes: "" });
      loadData();
    } catch {
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex gap-2 mt-4">
          ...
          {editId && (
            <button onClick={() => { setEditId(null); setForm({ academic_period_id: activePeriodId, exam_name: "", exam_date: "", total_examinees: "", total_passers: "", passing_rate: "", first_timers: "", first_timer_passers: "", first_timer_passing_rate: "", notes: "" }); }}
