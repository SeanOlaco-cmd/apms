...
export default function DHPartnerships() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSuccess("Partnership submitted! Waiting for Dean approval.");
      setForm({
        company_name: "",
        industry: "",
        partnership_type: "other",
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-[#7b1113] rounded-2xl p-6 text-white">
        ...
        <p className="text-red-200 text-sm mt-1">Submit partnership data for your school.</p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            ...
            <textarea name="description" value={form.description} onChange={handleChange}
              className="mt-1 w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#7b1113]"
              rows={3} placeholder="Brief description of the partnership..." />
          </div>
        </div>
