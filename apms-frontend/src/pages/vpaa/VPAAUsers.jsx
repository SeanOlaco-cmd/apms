...
export default function VPAAUsers() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setShowForm(false);
      setEditUser(null);
      setForm({ name: "", email: "", password: "", role: "department_head", school_id: "", program_id: "", is_active: true });
      loadData();
    } catch {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-[#7b1113] rounded-2xl p-6 text-white">
        ...
        <p className="text-red-200 text-sm mt-1">Manage all user accounts in the system.</p>
      </div>

      {success && <div className="bg-green-50 text-green-700 text-sm px-4 py-2 rounded-lg">{success}</div>}

      <div className="flex justify-end">
        <button onClick={() => { setShowForm(!showForm); setEditUser(null); setForm({ name: "", email: "", password: "", role: "department_head", school_id: "", program_id: "", is_active: true }); }}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select name="role" value={form.role} onChange={handleChange}
                ...
                <option value="nstp_head">NSTP Head</option>
