...
export default function VPAAStudentPerformance() {
  ...
  const handleApprove = async (id) => {
    await api.put(`/student-performance/${id}`, { status: "approved" });
    loadData();
  };
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-[#7b1113] rounded-2xl p-6 text-white">
        ...
        <p className="text-red-200 text-sm mt-1">Review and approve student performance data submitted by Deans.</p>
      </div>
