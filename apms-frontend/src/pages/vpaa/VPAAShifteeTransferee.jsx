  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-[#7b1113] rounded-2xl p-6 text-white">
        ...
        <p className="text-red-200 text-sm mt-1">Shiftee and transferee data across all schools.</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 text-gray-500 font-medium">Shiftees</th>
                <th className="text-left py-3 px-4 text-gray-500 font-medium">Transferees</th>
